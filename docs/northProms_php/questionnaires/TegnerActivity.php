...
if(isset($_POST['submit'])){
    ...
    $comment = $_POST['comment'];
        ...
        $sql = "INSERT INTO `TegnerActivity`(`activityLevelBeforeInjury`, `currentActivityLevel`, `hospitalNumber`, `answeredDate`,`code`,`comment`) VALUES ($q1,$q2,$hospitalNumber,'$day',$operation,'$comment')";
