...
if(isset($_POST['submit'])){
    ...
    $comment = $_POST['comment'];
        ...
        $sql =  " INSERT INTO `OxfordKeenScore`(`Q1`, `Q2`, `Q3`, `Q4`, `Q5`, `Q6`, `Q7`, `Q8`, `Q9`, `Q10`, `Q11`, `Q12`, `hospitalNumber`, `answeredDate`,`code`,`comment`) VALUES ($q1,$q2,$q3,$q4,$q5,$q6,$q7,$q8,$q9,$q10,$q11,$q12,$hospitalNumber,'$day',$operation,'$comment')";
  $db->query($sql);
