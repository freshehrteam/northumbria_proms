...
if(isset($_POST['submit'])){
    ...
    $comment = $_POST['comment'];
        ...
        $sql = "INSERT INTO `EQ5D5`(`Mobility`, `Self Care`, `Usual Activities`, `Pain/Discomfort`, `Anxiety/Depression`, `hospitalNumber`, `answeredDate`,`code`,`comment`) VALUES ($q1,$q2,$q3,$q4,$q5,$hospitalNumber,'$day',$operation,'$comment');";
  $db->query($sql);
