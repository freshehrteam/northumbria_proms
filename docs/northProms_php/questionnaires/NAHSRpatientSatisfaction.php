...
if(isset($_POST['submit'])){
    ...
    $comment = $_POST['comment'];
        ...
        $sql = " INSERT INTO `NAHSRpatientSatisfaction`(`Q1`, `Q2`, `Q3`, `Q4`, `Q5`, `Q6`, `hospitalNumber`, `answeredDate`,`code`,`comment`) VALUES ($q1,'$q2','$q3','$q4','$q5','$q6',$hospitalNumber,'$day',$operation,'$comment');";
  $db->query($sql);
